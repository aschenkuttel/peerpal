...
export default function Page({children, headerChildren}) {
    return (
        <div className="relative flex flex-col flex-1 bg-gray-900">
            <Header className="bg-transparent z-10 border-b-0 shadow-none">
                {headerChildren}
            </Header>
            ...
            <Footer className="z-10 bg-transparent border-t-0 shadow-none text-gray-200"/>
