...
import { dateFormat, amountFormat} from '../utils/parse'
    ...
    const content = () => {
        if (loading) {
            ...
            return <div className="w-full max-w-5xl">
                ...
                <div className="flex flex-col items-center h-full bg-gray-800 border border-gray-700 rounded-xl px-8 py-4 gap-12">
                    ...
                    <div className="text-end">
                        <p className="text-slate-200 mt-2 align-right">Date Issued: {dateFormat(receivedTx.timestamp)}</p>
                    ...
                    <div className="flex mt-5 max-w-2xl w-full">
                            ...
                            <div className="flex flex-col items-center">
                                <FontAwesomeIcon fixedWidth icon={faArrowsRotate} className="text-7xl text-gray-400 shrink-0"/>
